...
6. 负向提示词处理：MiniMax‑H3支持negative_prompt字段，正常输出负向提示；Wan2.2、LTX2.3正常输出负向提示。
7. MiniMax‑H3专用规则：
...
6. Negative prompt handling: MiniMax‑H3 supports negative_prompt field, output negative prompt normally. Wan2.2 & LTX2.3 output negative prompt normally.
